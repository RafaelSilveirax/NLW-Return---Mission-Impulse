...
export function ScreenshotButton({screenshot, onScreenshotTook}: ScreenshotButtonProps){
   ...
   async function handelTakeScreenshot(){
   ...
   if(screenshot){
       return(
           ...
           className="p-1 w-10 h-10 border-transparent flex justify-end items-end
    ...
    return(   
        <>
            <button 
                type="button"
                className="p-2 bg-zinc-800 border-transparent rounded-md
